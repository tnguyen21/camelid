...
This training script is designed for distributed data parallel (ddp) training
...
class Transformer(nn.Module):
    ...
    def estimate_mfu(self, fwdbwd_per_iter, dt):
        ...
        flops_promised = 1979e12  # H100 GPU bfloat16 peak flops is 1979 TFLOPS
...
# always expect DDP environment variables to be set
